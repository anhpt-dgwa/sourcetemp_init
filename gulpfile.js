...
const watchFiles = (done) => {
  ...
  watch(`${SRC_PATH}/scripts/**/*.js`, series(scriptNoWebpack, browserReload));
...
const buildFiles = series(
  clean,
  parallel(html, cssScss, scriptNoWebpack),
  validateHTML
);
// const buildFiles = series(
//   clean,
//   parallel(htmlPug, cssScss, scriptNoWebpack),
//   validateHTML
// );
// const buildFiles = series(
//   clean,
//   parallel(htmlEjs, cssStylus, scriptNoWebpack),
//   validateHTML
// );
